...
let spacing = 8
let tearDist = 65
let friction = 0.99 /* Yer cekimi hizi gibi, yaylanma gibi */
let bounce = 0.5 /* 3 cok gercekci */
...
let mouse = {
  cut: 8, /* ne kadar arttirirsak o kadar hizli ve keskin bi bicimde kesiyor */
  influence: 26, /*sanirim kopma kolayligi, dusurunce sol butonla bile kopuyor*/ 
  down: false,
  button: 1,
  x: 0,
  y: 0,
